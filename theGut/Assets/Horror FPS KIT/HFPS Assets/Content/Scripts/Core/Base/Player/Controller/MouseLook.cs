...
public class MouseLook : MonoBehaviour, IJsonListener
{
    ...
    void Update()
    {
        ...
        {
            rotationX = Mathf.LerpAngle(rotationX, lerpRotation.x, timekeeper.deltaTime * lerpSpeed);
            rotationY = Mathf.LerpAngle(rotationY, lerpRotation.y, timekeeper.deltaTime * (lerpSpeed * 0.8f));
        }
